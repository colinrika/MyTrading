...
function buildTelegramMessage(trades) {
  ...
  for (const t of trades) {
    ...
    const link = strategyLink(t.pair);
  ...
  if (!APP_BASE_URL) msg += "Set APP_BASE_URL to include clickable links.\n";
  return msg;
}
